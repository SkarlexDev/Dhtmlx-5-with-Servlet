...
public class TeacherServiceImpl implements TeacherService {
    ...
    public StringBuilder createXMLForm(String action) {
        ...
        if (action.equals("add")) {
            ...
            xml.append("<item type=\"input\" label=\"Name\" name=\"teacherName\" offsetLeft=\"15\" maxLength=\"30\" required=\"true\" /> ");
        ...
        if (action.equals("edit")) {
            ...
            xml.append("<item type=\"select\" label=\"Old name\" name=\"old-name\" offsetLeft=\"15\" maxLength=\"30\" required=\"true\"> ");
        ...
        if (action.equals("del")) {
            ...
            xml.append("<item type=\"select\" label=\"Old name\" name=\"teacherName\" offsetLeft=\"15\" maxLength=\"30\" required=\"true\"> ");
    ...
    @Override
    public boolean create(Teacher bean) {
